...
import RecipeReviewCardMoisture from "../product-moisturizer/moisturizer";
...
export default function RecipeReviewCard() {
  ...
  useEffect(() => {
    async function getData() {
      ...
      setProduct(response.data.slice(0, 3));
    }
    getData();
  }, []);
  function isFloat(n) {
  ...
  return (
    <>
      <h1> محصولات مراقبت پوستی</h1>
      <Link to="/products/category/faceWash/page/1">
        <h1 className="title">
          {" "}
          شوینده صورت
          <ArrowBackIosNewIcon />
